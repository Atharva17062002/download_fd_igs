...
import 'package:download_fd_igs/data.dart';
import 'download_list_item.dart';

final platformChannel = MethodChannel('com.example.myApp/platformChannel');
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<String?> _getSavedDir() async {
    ...
    if (Platform.isAndroid) {
      ...
      // var dir = (await _dirsOnIOS)[0]; // applicationDocuments
  ...
  // Future<List<String?>> get _dirsOnIOS async {
  //   final applicationDocuments = await FilePicker.platform.getDirectoryPath();
  //
  //   final dirs = [
